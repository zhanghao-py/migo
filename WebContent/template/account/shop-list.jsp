...
<body>
            ...
            <div class="table-products">
                ...
                <div class="row filter-block">
                    <div class="col-md-8 col-md-offset-5">
                        <form action="account/shop/search" method="POST" id="shop-search-form">
                        <div class="ui-select">
                            <select>
    ...
    <script type="text/javascript">
        ...
        function searchRepositories(currentPage, pageSize) {
            ...
            var url = $("#shop-search-form").attr('action');
            var method = $("#shop-search-form").attr('method');
            ...
            $.ajax({
                ...
                success: function(data, textStatus, jqXHR){
                    ...
                    $.each(data.data, function(i, e) {
                        ...
                        row.find("#market").text(e.marketId);
